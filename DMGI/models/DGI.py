        ...
        for m_idx, (features, adj) in enumerate(zip(features_lst, adj_lst)):
            ...
            for epoch in range(self.args.nb_epochs):
                ...
                if loss < best:
                    best = loss
                    cnt_wait = 0
                    torch.save(model.state_dict(), 'revision/best_{}_{}_{}.pkl'.format(self.args.dataset, self.args.embedder, metapath))
                else:
                    cnt_wait += 1
            ...
            model.load_state_dict(torch.load('revision/best_{}_{}_{}.pkl'.format(self.args.dataset, self.args.embedder, metapath)))
